...
def get_new_dataloader(args, session):
    txt_path_list = []
    txt_path = "/home/s4401040/nas_home_v2/DATA/CEC_index_list/" + args.dataset + "/session_" + str(session + 1) + '.txt'
...
def get_incremental_dataset_fs(args, session=None):
    ...
    for i in range(session + 1):
        if i == 0:
            txt_path = "/home/s4401040/nas_home_v2/DATA/CEC_index_list/" + args.dataset + '/session_{0}'.format(str(i + 1)) + '.txt'
        else:
            txt_path = "/home/s4401040/nas_home_v2/DATA/CEC_index_list/" + args.dataset + '/session_{0}'.format(str(i + 1)) + '.txt'
